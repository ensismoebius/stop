...
router.get("/:id/collaborative-correction", roundController.collaborativeCorrectionProgress);
router.post("/:id/collaborative-correction/finish", roundController.finishCollaborativeCorrection);
router.post("/:id/correction", roundController.correction);
router.get("/:id/correction", roundController.correctionGrid);
router.get("/:id/correction/grouped", roundController.groupedCorrectionGrid);
